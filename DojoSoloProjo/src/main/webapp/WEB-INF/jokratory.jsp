...
<head>
	...
	<title>Enter the Jokratory</title>
</head>
<body style="font-family: nunito, sans-serif">

	<div class="container mt-5">
		<a href="/dash" class="text-decoration-none text-secondary p-1 border border-warning rounded-bottom">Eh, You Tried Your Best</a>
	
	
		<h1 class="text-center">Hope They've Urinated Recently</h1>
		<div class="container mt-5 col-5">
			<div class="container ">
				<form:form action="/jokes/write" method="POST" modelAttribute="newJoke" class="form-control">
					...
					<div class="d-flex justify-content-end">
						<a href="/killtony" class="text-decoration-none text-secondary">Introduce Comedian</a>
					</div>
				</form:form>
			</div>
